...
const SortBar = ({options,selectedOption}) => {
    ...
    return (
        <div data-v-46b7d13b data-v-0796563c onClick={() => { setOpen(!open) }} /*onBlur={() => { if(open){setOpen(!open)} }} */  tabIndex={0} className="md-select focus:outline-none sm:w-auto w-full md-select--populated">
