const ErrorModal = ({msg,show,closeModal}) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                ></span>
                <img className="mx-auto" src='https://static.thenounproject.com/png/509635-200.png' style={{width:'100px',height:'100px'}}></img>
                ...
                <div onClick={closeModal} className="-mx-3 flex flex-wrap justify-center">
                    <div className="w-1/2 px-3">
                        <button
                            className="block w-full bg-orange-600 rounded-lg border border-black p-3 text-center text-base font-medium text-dark transition hover:bg-red-500 hover:text-white"
                        >
                            Cancel
                        </button>
                    </div>
