...
const StatisticsCards = ({data}) => {
    console.log(data)
    return (
        <div className=" w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4">
            <div className="bg-red-500 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-red-600  text-white font-medium group">
                ...
                <div className="text-right">
                    <p className="text-2xl">{data.data.totalUser}</p>
                    <p>User</p>
                </div>
            </div>
            <div className="bg-blue-500 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 text-white font-medium group">
                ...
                <div className="text-right">
                    <p className="text-2xl">{data.data.totalOrder}</p>
                    <p>Orders</p>
                </div>
            </div>
            ...
            <div className="bg-yellow-500  shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-yellow-600  text-white font-medium group">
                ...
                <div className="text-right">
                    <p className="text-2xl">{VNDFormat(700000000)}</p>
                    <p>Fund</p>
                </div>
            </div>
        </div>
